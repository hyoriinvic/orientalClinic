<?php
    ...
    if (isset($_POST["high_blood_pressure"]) && isset($_POST["diabetes"]) && isset($_POST["hepatitis"]) && isset($_POST["allergy"]) && isset($_POST["surgery_history"])
     && isset($_POST["medication"]) && isset($_POST["drinking"]) && isset($_POST["smoking"])) {
